            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">View Payments
                  </li>
                </ol>
              </div>
            </div>
					...
					<div class="card-content collapse show">
						<div class="table-responsive">
							<table class="table table-striped">
								...
								$res=mysqli_query($con,"SELECT * FROM `payment` WHERE `uid`='$_SESSION[uid]'");
								
								$i=1;
								while($row=mysqli_fetch_array($res))
									{
										$res1=mysqli_query($con,"SELECT * FROM `register` WHERE `id`='$_SESSION[uid]'");
