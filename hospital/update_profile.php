			  ...
			  ?>
                  <div class="card-body">
                      <form method="POST" action="">
						...
						<input type='text' class="form-control" value="<?php echo $row['location']; ?>"  name='loc' placeholder="Phone" ><br>
						<label>Phone</label>
						<input type='text' class="form-control" value="<?php echo $row['phone']; ?>"  name='phone' placeholder="Specialization" ><br>
						<label>Email</label>
